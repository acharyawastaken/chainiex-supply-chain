...
router.post('/', async (req, res) => {
  try {
    const { product_name, description, price, stock_quantity, supplier_id, category_id, image_url } = req.body;
    ...
    const result = await db.query(
      'INSERT INTO products (product_name, description, price, stock_quantity, supplier_id, category_id, image_url) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING product_id',
      [product_name, description || null, price, stock_quantity || 0, supplier_id, category_id, image_url || null]
    );
...
router.patch('/:id', async (req, res) => {
  try {
    ...
    await db.query(`
      ...
      WHERE product_id = $8
    `, [product_name, description, price, stock_quantity, supplier_id, category_id, image_url, req.params.id]);
